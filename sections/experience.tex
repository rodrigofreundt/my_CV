...
\entrybig
	{\textbf{Graduate Research Assistant}}{Ithaca, NY}
	{Working on multiple aspects of the CCAT/FYST project.}{2021 \textendash Present}
\innerlist{
	\entry{Ultimately responsible for the mechanical design of the Epoch of Reionization Spectrometer (EoR-Spec). The EoR-Spec has been designed to probe the 
	redshifted [C II] 158 $\mu$m fine-structure line emission from aggregates of galaxies in the early universe (z = 3.5 to 8).}
	\entryextra{It features a detector array of more than 6000 Kinetic Inductance Detectors (KIDs) and a cryogenic, scanning 
	Fabry-Perot Interferometer (FPI) that covers the full spectral range of 210-420 GHz with a resolving power of R $\sim$ 100.}
}
