...
Notes:
\begin{itemize}
    \item ABET accreditation for foreign degree attached as a separate file.
    \item Authorized to work in the US for any employer (No sponsorship required).
    \item Expected completion of Ph.D. degree: Spring 2027.
\end{itemize}
